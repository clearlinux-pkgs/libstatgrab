...
Source0  : https://github.com/libstatgrab/libstatgrab/releases/download/LIBSTATGRAB_0_92/libstatgrab-0.92.tar.gz
...
%prep
%setup -q -n libstatgrab-0.92
cd %{_builddir}/libstatgrab-0.92
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582660070
...
cp %{_builddir}/libstatgrab-0.92/COPYING %{buildroot}/usr/share/package-licenses/libstatgrab/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libstatgrab-0.92/COPYING.LGPL %{buildroot}/usr/share/package-licenses/libstatgrab/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
